/**
 * closure 패턴을 원활 하게 사용하기 위해 typescript의 강력한 기능인 '인터페이스' 기능을 통해
 * 주요구성과 사용방법을 정의하였다.
 */
 ...
 * 작성하면서 에러를 통해 인터페이스를 따르지 않았다는 것을 알 수있다.
 *
 */
...
// 전역변수를 사용하지 않고도, 함수를 호출 했을 때의 상태를 기억하고 있다.
// 전역변수는 그자체로 메모리 누수 (memory leak)의 원인이 된다.
